...
export default function Home() {
  ...
  return <div className="narrow">
    <div className="hdr">
      <div><h1>{user ? t('Hi {0}', user.name) : 'Health In Motion'}</h1><div className="sub">{today.toLocaleDateString(dateLocale(), { weekday: 'long', day: 'numeric', month: 'long' })}</div></div>
    ...
    {!S.routines.length && !S.active && (
      <div className="card">
        ...
        <div className="muted small" style={{ marginBottom: 12 }}>{t('Pick one of Nick’s programs to get going — or build your own week from scratch.')}</div>
        <Button variant="primary" icon="sparkles" onClick={starterPlanSheet}>{t('Choose a program')}</Button>
