...
export default {
  ...
  'A small file a friend imports into their own Health In Motion — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой Health In Motion — только программы, без твоих тренировок и взвешиваний.',
  ...
  'this isn’t a Health In Motion plan file': 'это не файл плана Health In Motion',
