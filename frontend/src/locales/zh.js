...
export default {
  ...
  'A small file a friend imports into their own Health In Motion — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 Health In Motion——只有训练日，不包含你的训练记录或体重。',
  ...
  'this isn’t a Health In Motion plan file': '这不是 Health In Motion 计划文件',
